...
public class PausePanel extends JPanel {
   PausePanel(){
      ...
      MyLabel pauseLabel = new MyLabel("GAME PAUSED", 0, 200, 1240,60, MyColor.netral, MyFont.MyFont().deriveFont(Font.BOLD, 50) ,true);
      MyButton quit = new MyButton( "Quit Game",300,300, 200,50 , MyColor.darkOrange, MyColor.lightOrange); 
      MyButton resume = new MyButton( "Resume", 1240-300-200,300, 200,50, MyColor.lightPurple, MyColor.darkPurple);
      ...
      resume.addActionListener(new ActionListener(){
         ...
         public void actionPerformed(ActionEvent arg0) {
            if (arg0.getSource() ==  resume){
               ...
               Main.se.play();
               Main.gameLayer.remove(GameFrame.pausePanel);
      ...
      quit.addActionListener(new ActionListener(){
         ...
         public void actionPerformed(ActionEvent arg0) {
            if (arg0.getSource() == quit){
               ...
               Main.gameLayer.remove(Main.board);
      ...
      // new MyLabel(text, x, y, w, h, c, f, center)
      this.add(resume);
      this.add(quit);
      this.add(pauseLabel);
   }
